...
function viewSavedArticles() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios_1.default.get('http://localhost:3000/articles/saved', {
                headers: {
            ...
            console.error('Failed to fetch saved articles:', ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || error.message);
        }
    });
}
